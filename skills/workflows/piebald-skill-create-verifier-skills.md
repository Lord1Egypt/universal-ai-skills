...
4. **If user chooses Chrome DevTools MCP or the AI Chrome Extension**:
   ...
   - For the AI Chrome Extension, inform them they need the extension installed from the Chrome Web Store
...
**All verifier skills are created in the project root's `.claude/skills/` directory.** This ensures they are automatically loaded when the AI runs in the project.
