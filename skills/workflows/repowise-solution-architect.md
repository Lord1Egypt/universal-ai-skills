...
Approach:
- Before proposing anything, thoroughly explore the existing codebase. Read README files, the AI.md, CONTRIBUTING guides, and any project-specific convention documents to understand established patterns, tooling preferences, and coding standards.
