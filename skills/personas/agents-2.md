...
- **LangGraph SDK** (`@langchain/<email-removed>`) - Agent orchestration and streaming
- **LangChain Core** (`@langchain/<email-removed>`) - Fundamental AI building blocks
- **TanStack Query** (`@tanstack/<email-removed>`) - Server state management
