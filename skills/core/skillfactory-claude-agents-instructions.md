# the AI coding agent Agents Reference

**Complete guide to creating and managing specialized AI agents (subagents) in the AI coding agent**
...
the AI coding agent Agents (also called **subagents**) are specialized AI assistants that handle specific types of tasks. Each agent operates independently with:
...
**When to Use Agents**: the AI coding agent automatically delegates tasks to appropriate agents based on their descriptions, or you can invoke them explicitly.
...
# Generate with the AI first, then customize
...
| **Create New** | Guided setup with the AI generation |
...
- "Use **proactively**" - the AI should use without being asked
...
**Start with the AI Generation**:
1. Use `/agents create` and describe your needs
2. Let the AI generate initial agent
...
**Symptoms**:
- the AI doesn't delegate to your agent
...
INVOCATION
├─ Automatic: the AI delegates based on description
