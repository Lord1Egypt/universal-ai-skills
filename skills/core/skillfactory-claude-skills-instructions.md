...
|----------------|-------------|
| **Composable** | Skills stack together - the AI coordinates multiple skills automatically |
| **Portable** | Same format across the AI apps, the AI coding agent, and API |
...
2. the AI scans available skills for relevant matches
3. When a match is found, the AI loads only minimal needed files
4. Skill is applied to the task
5. Result is returned with skill usage visible in chain of thought

### Skill Composition

**Multiple Skills**: the AI automatically identifies which skills are needed and coordinates their use together.
...
## Skills Across the AI Products

### 1. the AI Apps (the AI.ai)

**Availability**: Pro, Max, Team, and Enterprise users

**Features**:
- the AI provider-provided skills for common tasks (Excel, PowerPoint, Word, PDF)
...
**Requirements**:
- [Code Execution Tool](https://docs.the AI.com/en/docs/agents-and-tools/tool-use/code-execution-tool) beta
...
**Documentation**: [API Skills Guide](https://docs.the AI.com/en/api/skills-guide)

### 3. the AI coding agent

**Availability**: All the AI coding agent users

**Installation Methods**:

**Option A: Marketplace (Recommended)**
```bash
# Install from the AI providers/skills repository
...
**Features**:
- the AI loads skills automatically when relevant
...
**GitHub Repository**: [the AI providers/skills](https://github.com/the AI providers/skills)
...
6. Install to your the AI environment
...
- Cross-platform portability (API + the AI coding agent + Apps)
...
- [ ] **Choose your platform**: the AI apps, API, or the AI coding agent
- [ ] **Enable skills**: Check settings or configuration
- [ ] **Try built-in skills**: Test Excel, PowerPoint skills
- [ ] **Browse examples**: Visit [github.com/the AI providers/skills](https://github.com/the AI providers/skills)
...
### Box
> "Skills teaches the AI how to work with Box content. Users can transform stored files into PowerPoint presentations, Excel spreadsheets, and Word documents that follow their organization's standards—saving hours of effort."
>
> — Yashodha Bhavnani, Head of AI, Box

### Notion
> "With Skills, the AI works seamlessly with Notion - taking users from questions to action faster. Less prompt wrangling on complex tasks, more predictable results."
>
...
### Rakuten
> "Skills streamline our management accounting and finance workflows. the AI processes multiple spreadsheets, catches critical anomalies, and generates reports using our procedures. What once took a day, we can now accomplish in an hour."
>
...
**Source**: https://www.the AI provider.com/news/skills
**Official Documentation**: https://docs.the AI.com/en/docs/agents-and-tools/agent-skills/overview
