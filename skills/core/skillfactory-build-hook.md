# /build-hook - Build Custom the AI coding agent Hooks
...
- SessionStart: Load context when the AI starts
...
**SessionStart** - Run when the AI coding agent starts/resumes
...
**The easiest way to automate your the AI coding agent workflow!** 🔧🚀
