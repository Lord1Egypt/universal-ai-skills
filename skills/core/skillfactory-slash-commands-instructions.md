...
| `/bug`                    | Report bugs (sends conversation to the AI provider)                                                                                                |
...
| `/login`                  | Switch the AI provider accounts                                                                                                                    |
| `/logout`                 | Sign out from your the AI provider account                                                                                                         |
...
Custom slash commands allow you to define frequently-used prompts as Markdown files that the AI coding agent can execute. Commands are organized by scope (project-specific or personal) and support namespacing through directory structures.
...
MCP servers can expose prompts as slash commands that become available in the AI coding agent. These commands are dynamically discovered from connected MCP servers.
...
To encourage the AI to trigger `SlashCommand` tool, your instructions (prompts,
the AI.md, etc.) generally need to reference the command by name with its slash.
...
descriptions shown to the AI. This prevents token overflow when many commands
are available.
...
When the character budget is exceeded, the AI will see only a subset of the
available commands. In `/context`, a warning will show with "M of N commands".

## Skills vs slash commands

**Slash commands** and **Agent Skills** serve different purposes in the AI coding agent:
