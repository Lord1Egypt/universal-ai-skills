...
Complete documentation for GitHub automation system powered by the AI AI - covering setup, usage, workflows, emergency procedures, and troubleshooting.
...
- **Automatic Code Reviews** - the AI reviews every PR automatically
...
2. the AI review triggers automatically (30 seconds)
