...
description: Automatically update the AI.md file based on recent code changes
---

# Update the AI.md File

## Current the AI.md State
@the AI.md
...
Based on the current the AI.md content and all the git analysis above, create an updated the AI.md file that:
...
Intelligently update these the AI.md sections:
...
- **Maintain structure**: Follow existing the AI.md organization
- **Add timestamps**: Note when major updates were made

## 5. Output Format
Provide the complete updated the AI.md content, organized as:
