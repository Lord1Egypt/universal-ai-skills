...
**Install a generated hook to the AI coding agent settings (user-level or project-level).**
...
Next steps:
1. Restart the AI coding agent (required)
...
3. Save and restart the AI coding agent
...
**Managing hooks**:
- Run `/hooks` in the AI coding agent to view and manage all hooks
- Use the AI coding agent's settings menu to edit hook configuration
...
- Use `/hooks` command in the AI coding agent to view active hooks
