...
[the AI coding agent](https://the AI.com/the AI-code) is an AI coding agent that can help with:
...
Once this PR is merged, we'll be able to interact with the AI by mentioning @the AI in a pull request or issue comment.
...
- **@the AI mentions won't work until after the merge is complete**
...
- the AI's default tools are limited to reading/writing files and interacting with our repo by creating comments, branches, and commits.
...
There's more information in the [the AI coding agent action repo](https://github.com/the AI providers/the AI-code-action).

After merging this PR, let's try mentioning @the AI in a comment on any PR to get started!
