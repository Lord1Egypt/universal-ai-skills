...
Adapt the GitHub workflow blueprint to create an automated, the AI coding agent-integrated branching and PR workflow for the Skills Factory repository that:
...
| **No the AI coding agent review integration** | Missing automated reviews | Reviews done manually |
...
sk-[a-zA-Z0-9]{32}    # the AI provider API key
```
...
**Actions**:
1. Fetch PR diff
2. Run the AI coding agent Action for review
...
**Adaptation Notes**:
- Requires `the AI provider_API_KEY` secret
...
2. **Update README.md** - Add workflow section
   ...
   This repository uses an automated GitHub workflow with the AI coding agent integration.
...
3. **Update the AI.md** - Add workflow context
   ```markdown
   ## Branching Workflow
...
**5. Update the AI.md with workflow rules**
...
- [ ] the AI.md updated with workflow rules
...
### Week 3 Goals
- [ ] the AI coding agent review integration
