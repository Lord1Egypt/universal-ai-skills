...
2. Paste at the start of a new the AI conversation
3. the AI will maintain this configuration throughout

[IF the AI assistant FORMAT]:
1. Go to the AI assistant Settings → Personalization → Custom Instructions
...
Use the Product Manager preset, generate in the AI format, Core mode
