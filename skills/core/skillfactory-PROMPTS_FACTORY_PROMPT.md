# the AI Prompts Factory - Meta-Prompt Template
...
[Domain-specific best practices + the AI provider/the AI provider/Google]
...
**Format 3: the AI assistant Custom Instructions**
```
What would you like the AI assistant to know about you to provide better responses?
...
1. **LLM Best Practices** (the AI provider/the AI provider/Google)
   - Clear instructions
   - Structured output
   - Examples-driven
   - Context provision
