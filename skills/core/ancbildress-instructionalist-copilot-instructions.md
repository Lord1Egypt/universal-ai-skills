# The Instructionalist Agent - Sample the AI assistant Instructions Output 🧾
...
```markdown
# GitHub the AI assistant Instructions for awesome-github-the AI assistant

## Project Overview

- **Main purpose and value:** Define a reusable, fun set of agents, prompts, and instructions that can be customized for GitHub the AI assistant. Designed to make the AI assistant more interesting and engaging.
- **User ecosystem:** Users of GitHub the AI assistant, especially those seeking curated, tested, and entertaining enhancements for the AI assistant’s behavior.
- **Core functionality:** Provides personally curated and tested agents, prompts, and instructions for the AI assistant; some are final, others are in early development. Does not perform any actual coding or data processing.
...
- **Ideal the AI assistant usage:** the AI assistant should help users explore, select, and understand different agents and prompts, making the experience fun and engaging.
- **Pain points to solve:** Reduce friction in customizing the AI assistant’s behavior; make it easy to try new modes and understand their purpose.
...
These were added as an experiment to see if they could work universally. If you’re on Business or Enterprise the AI assistant, double-check your org-wide instructions first — you don’t want to accidentally clash with them.
