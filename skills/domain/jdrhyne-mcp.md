...
the AI agent config directory PROJ-123 PROJ-456 "Depends On"

# PROJ-100 blocks PROJ-200
the AI agent config directory PROJ-100 PROJ-200 "Blocks"

# General relationship
the AI agent config directory PROJ-50 PROJ-75 "Relates To"
```
