...
### Option 2: the AI coding agent Plugin (Marketplace)

If you use the AI coding agent, install as a plugin for
...
### Option 3: the AI coding agent Plugin (Git / Local)
...
Skills follow the
[Agent Skills](https://platform.the AI.com/docs/en/agents-and-tools/agent-skills/overview)
...
### Automatic Detection (the AI coding agent only)
...
When detected, the AI is guided to use the appropriate
skill for each task.
...
3. For the AI coding agent plugin installs, verify detection:
...
- [Agent Skills specification](https://platform.the AI.com/docs/en/agents-and-tools/agent-skills/overview)
